...
class bt_cc_item {
	...
	static function handle_shortcode( $atts, $content ) {
		...
		if ( $type == 'text' ) {
			...
			$input = '<input type="text" class="btQuoteText" data-condition="' . $condition . '" data-price="' . $price . '" value="' . $initial_value . '"/>';
			...
			$input = '<div id="' . $dd_id . '" class="btQuoteSelect btContactField btDropDown" data-condition="' . $condition . '"></div>';
			...
			$input = '<div class="btQuoteSlider" data-value="' . $initial_value . '" data-min="' . $arr[0] . '" data-max="' . $arr[1] . '" data-step="' . $arr[2] . '" data-price="' . $price . '" data-offset="' . $offset . '" data-condition="' . $condition . '"></div><span class="btQuoteSliderValue"></span>';
			...
			$input = '<div class="btQuoteSwitch' . $class_on . '" data-off="' . $arr[0] . '" data-on="' . $arr[1] . '" data-condition="' . $condition . '"><div class="btQuoteSwitchInner"></div></div>';
