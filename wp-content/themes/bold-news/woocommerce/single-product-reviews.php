			...
			<div id="review_form">
				<?php
					...
					if ( $account_page_url = wc_get_page_permalink( 'myaccount' ) ) {
						$comment_form['must_log_in'] = '<p class="must-log-in">' .  sprintf( esc_html__( 'You must be <a href="%s">logged in</a> to post a review.', 'bold-news' ), esc_url( $account_page_url ) ) . '</p>';
					}
